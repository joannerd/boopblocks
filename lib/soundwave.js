...
synthnotes.forEach((synth, i) => {
  ...
  playButtons[i].addEventListener('click', () => {   
    ...
    Array.from(synth.children[0].children[0].children).forEach((child, j) => {
      child.addEventListener("mouseenter", () => playSound(synth, j));
      child.addEventListener("click", () => playSound(synth, j));
    })
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelector("#mute").addEventListener('click', () => alert('Mute function in progress!'))
